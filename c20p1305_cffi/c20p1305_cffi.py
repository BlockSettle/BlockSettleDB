...
is also a feature to link to system and discoberable shared libs.

The CFFI model seems favor shared libraries. It is preferable to only let it
build the narrow set of C functions that need exposed to Python and let it 
...
at avoid poluting the original C headers.
