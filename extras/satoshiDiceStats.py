...
for targ in Targets:
   ...
   print(str(targ).rjust(10), end=' ') 
   print(('%0.6f' % avg).rjust(12), end=' ')
   print(('%0.4f' % sqrt(var)).rjust(12), end=' ')
...
for targ in Targets:
   ...
   print(('%0.6f' % avg).rjust(12), end=' ')
   print(('%0.4f' % sqrt(var)).rjust(12), end=' ')
   print(('%0.4f' % (3*sqrt(var))).rjust(12), end=' ')
